...
/**
 * Default Chum application HTML Error Renderer
 */
class ChumErrorRenderer extends AbstractErrorRenderer
{
    protected string $defaultErrorTitle = 'Chum Application Error';
